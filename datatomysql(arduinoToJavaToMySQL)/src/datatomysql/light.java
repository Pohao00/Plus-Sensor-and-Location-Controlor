...
public class light implements SerialPortEventListener {
	...
	private static final int DATA_RATE = 9600;//閮剖�aud rate�9600

	//閮剖�erver IP,撣唾��,撖Ⅳ
	static final String JDBC_DRIVER = "com.mysql.jdbc.Driver";//閮剖�DBC driver  
	static final String DB_URL = "jdbc:mysql://140.120.14.118/android";//server IP敺���澈��迂
	...
	public void serialEvent(SerialPortEvent oEvent) {
		...
		if (oEvent.getEventType() == SerialPortEvent.DATA_AVAILABLE) {//if data available on serial port
			try {
	            ...
	            PreparedStatement pstmt = connection.prepareStatement("UPDATE sample SET numb='"+inputLine+"' ");
